...
function EventPricing() {
	...
	return (
		<div className="bg-[radial-gradient(89.3%_50%_at_50%_52%,_#001B57_0%,_#000A19_100%)] pb-20">
			<div id="event_packages" className="g_container--theme pt-[150px] ">
				...
				<div className="max-w-[1576px] mx-auto mt-5 grid grid-cols-2 gap-8 px-[140px] pt-[60px] pb-[44px] rounded-[14px] border-b-[1px] border-b-[#0085FF20] bg-gradient-to-t from-[rgba(255,255,255,0.10)] to-[rgba(255,255,255,0.00)] shadow-[2px_4px_30px_0px_rgba(0,0,0,0.10)] backdrop-blur-[35px]">
					...
					<div className="flex items-start gap-2.5">
						...
						<span className="text-[14px] text-[#A3A3A3]">Friendly Staff Support – Our team will guide you through the adventure & check in on your party.</span>
					</div>
					<div className="flex items-start gap-2.5">
						<svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none" className="flex-none">
							<path
						...
						<span className="text-[14px] text-[#A3A3A3]">Want More? – Ask us about decorations, themed immersive events, catering, mini-game add-ons, and even full facility buy-outs!</span>
					</div>
				</div>
