...
function Testimonial() {
	return (
		<div>
			<div className="max-w-[1330px] mx-auto pb-10 px-2.5 ">
				<h2 className="text-[#EDEDED] text-center">What Our Adventurers Are Saying</h2>
				<p className="text-[14px] sm:text-[16px] pt-3 text-[#A3A3A3] text-center max-w-[680px] mx-auto">
					Hear directly from our guests about why Quest Room is home to the best escape rooms in Los Angeles, and find out what makes our thrilling,
			...
			<div className="max-w-[1440px] mx-auto  relative pb-20">
				<div className=" ">
					...
					<Swiper
						...
						className="thrillTempletTestimonialSwiper thrillOnlyTestimonialSwiper thrillTempletSwiper planoTestimonial"
								...
								<div className="max-w-[950px] pt-[50px] md:pt-[100px] ml-4 md:ml-28 mr-4 md:mr-20 ">
									...
									<div className="relative ">
										<p className={`relative text-[15px] sm:text-[16px] md:text-[18px] italic text-center md:text-start text-[#D9D9D9]`}>
											...
											interaction scaling the difficulty to keep things fun Steve was really great, the kids had a blast (the 7 year old couldn't stop
											asking questions/talking about it after, the youngest was confused at times but still had lots to do and was not scared) having
											an actor was so fun. There were challenges for the puzzle experts and more kid friendly help the forest animals / find stuff
											kind of things
										</p>
									</div>
								...
								<div className="max-w-[950px] pt-[50px] md:pt-[100px] ml-4 md:ml-28 mr-4 md:mr-20 ">
									...
									<div className="relative ">
										<p className={`relative text-[15px] sm:text-[16px] md:text-[18px] italic text-center md:text-start text-[#8CA482]`}>
											...
											immersive. The Perfumer was more immersive than any other room we've done before, and we've done a lot! The Game Master John was
											masterful. It really felt like you were in historic Paris! The puzzles were engaging and non-linear. We would HIGHLY recommend
											this game and this venue!
										</p>
									</div>
