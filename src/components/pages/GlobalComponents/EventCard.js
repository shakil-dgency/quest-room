		...
		<div className="max-w-[1349px] mx-auto relative">
			<div className={`max-w-[1030px] ${index % 2 === 0 ? "" : "ml-auto"} pl-[75px] pt-[45px] pb-[50px] rounded-[14px] grid grid-cols-4 relative`} >
				...
				<div className={`relative ${index % 2 === 0 ? "col-start-1 col-end-4" : "col-start-2 col-end-5 pl-12"} `}>
					<p className="text-[18px] text-[#A3A3A3]">Escape Room</p>
					<p className="text-[32px] text-[#D9D9D9] font-[700]">Bachelorette Parties</p>
					<p className="text-[16px] text-[#A3A3A3] mt-[18px] max-w-[585px] font_poppins">
					...
					<div className="flex flex-col-reverse sm:flex-row items-center mt-10 gap-[25px]">
